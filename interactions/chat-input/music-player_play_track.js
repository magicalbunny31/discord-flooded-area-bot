...
export default async (interaction, firestore) => {
   ...
   if (!track)
      return await interaction.reply({
         content: strip`
            ### ❌ Track not found.
            > - Try selecting an option from the inline autocomplete choices when using ${emojis.area_communities_bot} ${Discord.chatInputApplicationCommandMention(`music-player`, `play`, `track`, interaction.commandId)}.
         `,
         ephemeral: true
      });
