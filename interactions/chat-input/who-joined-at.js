...
export default async (interaction, firestore) => {
   ...
   return await interaction.editReply({
      content: strip`
         👤 **${member ? member : positionOrMember} is the \`${(position ? position : positionOrMember).toLocaleString()}${getOrdinalSuffix(position ? position : positionOrMember)} member\` of \`${interaction.guild.memberCount.toLocaleString()} members\`**
