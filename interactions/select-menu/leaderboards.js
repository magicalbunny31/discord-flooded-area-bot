...
export default async (interaction, firestore) => {
   ...
   const keyv = new Keyv({
      store: new KeyvFile({
         filename: `./database/leaderboards/${menu || menuOrSubmenu}.json`
      })
   });
            ...
            new Discord.StringSelectMenuBuilder()
               ...
               .setOptions(
                  new Discord.StringSelectMenuOptionBuilder()
                     ...
                     .setLabel(`Currency`)
                     .setValue(`currency`)
                     .setDefault(menu || menuOrSubmenu === `currency`),
                  new Discord.StringSelectMenuOptionBuilder()
                     .setEmoji(`📈`)
                     .setLabel(`Levelling`)
                     .setValue(`levels`)
                     .setDefault(menu || menuOrSubmenu === `levels`)
               )
         )
   ];
