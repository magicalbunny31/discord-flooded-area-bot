export const data = new Discord.SlashCommandBuilder()
   .setName(`kick`)
   .setDescription(`Kick a player in-game in Flooded Area 🌊`)
   .addIntegerOption(
...
export default async interaction => {
   ...
   interaction.client.moderations.push({
      ...
      value:       playerId,                  // player (id)           to kick
      displayName: userByUserId?.displayName, // player (display name) to kick
      username:    userByUserId?.name,        // player (username)     to kick
      ...
      moderator: interaction.user.id // the id of the moderator who sent this kick
   });
